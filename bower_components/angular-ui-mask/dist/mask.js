...
angular.module('ui.mask', [])
        ...
        .provider('uiMask.Config', function() {
            ...
            this.modelViewValue = function(modelViewValue) {
                return options.modelViewValue = modelViewValue;
            };
                ...
                return {
                    ...
                    compile: function uiMaskCompilingFunction() {
                        ...
                        return function uiMaskLinkingFunction(scope, iElement, iAttrs, controller) {
                            ...
                            // Rafhael - Não está reconhecendo o provider para fazer configuração, então forcei o comportamento para true
